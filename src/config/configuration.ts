export default () => {
  ...
  return {
    ...
    PATIENT_LAB_RESULTS_TEMPLATE_ID: process.env.PATIENT_LAB_RESULTS_TEMPLATE_ID || "d-0ac8f9f0ef384192b300baf53a292b41",
    APPOINTMENT_REMINDER_TEMPLATE_ID: process.env.APPOINTMENT_REMINDER_TEMPLATE_ID || "d-c52a3df012b1456da9c6a255b91db79b",
