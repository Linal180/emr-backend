export default () => {
  ...
  return {
    ...
    NOTIFICATION_ADMIN_NEW_SIGN_UP_TEMPLATE_ID:
      process.env.NOTIFICATION_ADMIN_NEW_SIGN_UP_TEMPLATE_ID ||
      "d-c4f935c3674b4341a10b3c226cea1b86",
    REQUEST_INITIATED:
      process.env.REQUEST_INITIATED || "d-156bae7fc5444c7bbbae2044f1d6e97b",
    UPDATE_DONE:
      process.env.UPDATE_DONE || "d-6048b558485c4873b1331834356a7a83",
    REQUEST_APPROVED:
      process.env.REQUEST_APPROVED || "d-59063472f76c4c5f9acb74cc93d0bf95",
    REQUEST_UPDATE_NEEDED:
      process.env.REQUEST_UPDATE_NEEDED || "d-80fb471a2ddc4d2bbf4305a164ff7164",
    REQUEST_UPDATE_DECLINED:
      process.env.REQUEST_UPDATE_DECLINED ||
      "d-6343679f0f5448eaacdc0cb0a3ba4edc",
    FORGOT_PASSWORD_TEMPLATE_ID:
      process.env.FORGOT_PASSWORD_TEMPLATE_ID ||
      "d-c40af5d836ec4f029f9f9da1f9a06515",
    redis,
