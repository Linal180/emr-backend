...
export const claimMedValidation = Joi.object({
  ...
  pat_sex: Joi.string().required().label('Patient Gender'),
  ins_name_l: Joi.string().required().label('Insurance Last Name'),
  ins_name_f: Joi.string().required().label('Insurance First Name'),
  pat_addr_1: Joi.string().required().label('Patient Address'),
  pat_city: Joi.string().required().label('Patient City'),
  pat_state: Joi.string().required().label('Patient State'),
  pat_zip: Joi.string().required().label('Patient Zip Code'),
  ins_addr_1: Joi.string().required().label('Insurance Address'),
  ins_city: Joi.string().required().label('Insurance City'),
  ins_state: Joi.string().required().label('Insurance State'),
  ins_zip: Joi.string().required().label('Insurance Zip Code'),
  diag_1: Joi.string().required().label('At least one diagnose'),
  place_of_service_1: Joi.string().label('POS code').required(),
  from_date_1: Joi.string().required().label('Date of service'),
