                   ...
                   <td align="center" style="border:1px solid black">
                     <table class="col-600" width="600" align="center" border="0" cellspacing="0" cellpadding="0">
                       <tbody>
                         <tr>
                           <td>
                             <table class="col1" width="260" border="0" align="left" cellpadding="0" cellspacing="0">
                               <tbody>
                                 <tr>
                                   <td height="20"></td>
                                 </tr>
                                 ...
                                 <tr>
                                   <td align="center">
                                     <img style="display:block; line-height:0px; font-size:0px; border:0px;max-width:100%" class="images_style" src="http://cdn.mcauto-images-production.sendgrid.net/22b202cae41dc874/55e5ba70-143f-49c3-9850-34089f655fd5/338x444.png" alt="img" width="160" height="auto">
                                   </td>
                                 </tr>
                             ...
                             <table class="col3_one" width="340" border="0" align="right" cellpadding="0" cellspacing="0" style="border-left:1px solid black">
                               <tbody>
                                 <tr align="left" valign="top">
                                   <td
                                     style="font-size:8px; color:#ffffff; background-color: grey;text-align: center;padding: 10px; line-height:30px; font-weight: bold;">
                                     SPECIMEN
                                   </td>
                                 </tr>
                                   ...
                                   <td>
                                     <table class="col1" width="96%" style="padding-right: 5px" border="0" align="left" cellpadding="0" cellspacing="0">
                                       <tbody>
                                         <tr>
                                           <td
                                             style="font-size:8px; color:#000; line-height:24px; font-weight: 500;padding-left: 5px;">
                                             Patient No:
                                           </td>
   
                                           <td style="background-color: #eeeeee;color: #000;padding:10px;min-width: 100px;font-size:8px;">
                                             ${patientRecord}
                                           </td>
                                         </tr>
                                       </tbody>
                                 ...
                                 <tr align="left" valign="top">
                                   <td>
                                     <table class="col1" width="96%" style="padding-left: 5px" border="0" align="left" cellpadding="0" cellspacing="0">
                                       <tbody>
                                         <tr>
                                           <td
                                             style="font-size:8px; color:#000; line-height:24px; font-weight: 500;padding-left: 5px;">
                                   ...
                                   <td style="padding-left: 5px">
                                     <table class="col1" width="96%" style="padding-right: 5px" border="0" align="left" cellpadding="0" cellspacing="0">
                                       <tbody>
                                         <tr>
                                           <td
                                             style="font-size:8px; color:#000; line-height:24px; font-weight: 500;">
                                             Name:
                                           </td>
                   ...
                   <td align="center" style="border:1px solid black;">
                     ...
                     <tbody>
                      <tr>
                       ...
                       <tr>
                         <td align="center" style="background-color: #eeeeee;color: #000;padding:10px;min-width: 100%;font-size:8px;">
                             ...
                             <table class="col11" width="260" border="0" align="left" cellpadding="0" cellspacing="0">
                               <tbody>
                                 ...
                                 <tr align="center" valign="top">
                                   <td style="padding-left: 5px">
                                   ${labTests?.map((test) => (
                                    `<table class="col1" width="96%" style="padding-right: 5px" border="0" align="center" cellpadding="0" cellspacing="0">
                                       <tbody>
                                         <tr>
                                           <td
                                             style="font-size:8px; color:#000; line-height:24px; font-weight: 500;min-width: 100px;">
                                             ${test?.test?.component || ''}
                                           </td>
                                         </tr>
                                       </tbody>
                                 ...
                                 <tr align="left" valign="top">
                                   ...
                                   ${labTests?.map((test) => (
                                    ...
                                    <tbody>
                                      <tr>
                                        <td style="background-color: #eeeeee;color: #000;padding:10px;font-size:8px;">
                                     ...
                                     <table class="col1" width="96%" style="padding-right: 5px" border="0" align="center" cellpadding="0" cellspacing="0">
                                       <tbody>
                                         <tr>
                                           <td
                                             style="font-size:8px; color:#000; line-height:24px; font-weight: 500;">
                                             PKamp™ Respiratory SARS-CoV-2 RT-PCR
                                           </td>
                                         </tr>
                                       </tbody>
                                     </table>
                 ...
                 <tr>
                   <td align="left" style="border:1px solid black;">
                     ...
                     <tbody>
                      <tr>
                         <td
                           style="font-size:8px; color:#000; text-align: left;padding: 10px; line-height:30px; font-weight: bold;">
                           COMMENT:
                         </td>
                       </tr>
         
                       <tr>
                         <td align="left" style="color: #000;padding:10px;font-size:8px;">
                 ...
                 <tr>
                   <td align="left" style="border:1px solid black;">
                     ...
                     <tbody>
                       <tr>
                         <td
                           style="font-size:8px; color:#000; text-align: left;padding: 10px; line-height:18px; font-weight: bold;">
                           ${facilityName}
                         </td>
                       </tr>
