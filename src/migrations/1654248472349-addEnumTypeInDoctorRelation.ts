...
export class addEnumTypeInDoctorRelation1654248472349 implements MigrationInterface {
    name = 'addEnumTypeInDoctorRelation1654248472349'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."DoctorPatients_relation_enum" AS ENUM('Preferred provider in practice', 'Backup provider in practice', 'Primary care provider', 'Referring provider', 'Ordering provider', 'Other provider')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."DoctorPatients_relation_enum_old" AS ENUM('Preferred provider in practice', 'Backup provider in practice', 'Primary care provider', 'Referring provider', 'Other provider')`);
        await queryRunner.query(`ALTER TABLE "DoctorPatients" ALTER COLUMN "relation" DROP DEFAULT`);
