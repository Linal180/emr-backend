...
export class FacilityResolver {
  ...
  // async createAppointment(@Args('createFacilityInput') createFacilityInput: CreateFacilityInput) {
  //   return {
  //     facility: await this.appointmentService.createFacility(createFacilityInput),
